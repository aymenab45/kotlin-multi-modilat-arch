package com.example.multimodularapplication
...
import com.example.multimodularapplication.nav.addComposableDestinations
...
import com.example.navigator.destinitions.Screens
...
fun AppScaffold(appNavigator: AppNavigator) {
    ...
    Scaffold(modifier = Modifier.fillMaxSize()) { innerPadding ->
        NavHost(
            ...
            startDestination = Screens.LoginScreenRoot.route,
